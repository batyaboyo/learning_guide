...
A professional, local-first career development tracking website.

## Features

- **2 Career Paths**: Cybersecurity and Data Analyst.
...
- **Dark/Light Mode**: Manual theme toggle with saved preference.
...
- The app ships with a web manifest for installability support.
- Full offline behavior depends on browser caching behavior, because no service worker is currently included.
